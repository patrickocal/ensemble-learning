...
\begin{taggedblank}{$\textup{A}3$}[Archimedean axiom for $\ext$]\label{A} For
  ...
  \end{taggedblank}
%-----------------------------------------------------------------------------%
%\subsection{Regular generalizations}
\emph{The diversity axioms}~that now follow apply to regular generalizations.
They require that $\mbbd$ is sufficiently rich to support $Y$-{generalization}s
$\ext$ with a variety of
...
\end{taggeddiv}
The following axioms substantively weaken \threediv\ and \emph{a fortiori} \fourdiv.
...
A given diversity condition \emph{holds on $Z$} if the axiom holds with
$Z$ in the place of $X$. For the present purposes, \parthreediv\ and
\condtwodiv\ are equivalent:

\begin{observation}\label{obs-c2d} Let $\preceq_{\mbbd}$ satisfy
  \ref{T}--\ref{A}. Then \ref{p3d} and \ref{c2d} are equivalent.
\end{observation}
...
%-----------------------------------------------------------------------------%
% \subsection{Novel generalizations}
