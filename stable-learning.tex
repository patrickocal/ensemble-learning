...
%The third implication provides further motivation for the present
%generalization of \gsii.
...
representation result for a bond-market setting. In \cref{sec-applications} we also
...
\begin{axioms*}
  ...
  \begin{enumerate}[label=\textup{B\arabic*}] \setcounter{enumi}{-1}
