...
\end{abstract}
  ...
  survival
  \citep{bartlett1933remembering,suddendorf2007evolution,mullally2013memory}.
  ...
  %\citep[page 7, experiment 1]{chervonenkis2015chervonenkis's} and considers the
...
and $x_k < x_{k + 1}$ for all feasible $k$.  \begin{remark*}[on zero-coupon
  bonds] Although coupon-paying bonds are far more common, Zeros provide a
